...
M.globalkeys = gears.table.join(
    ...
    awful.key({modkey,            }, "KP_End", 
              function () awful.spawn("vivaldi-stable", {tag="4-web", screen=2}) end,
              {description = "1 Vivaldi",  group = "applications"}),
    --2
    awful.key({modkey,            }, "KP_Down", 
              function () awful.spawn("joplin-desktop", {tag="2-notes", screen=2}) end,
              {description = "2 Joplin", group = "applications"}),
    --3
    awful.key({modkey,            }, "KP_Page_Down", 
              function () awful.spawn("spotify", {tag="8-music",screen=2}) end,
              {description = "3 Spotify", group = "applications"}),
    --4
    awful.key({modkey,            }, "KP_Left", 
              function () awful.spawn("enpass", {tag="9-pw", screen=2}) end,
              {description = "4 Enpass", group = "applications"}),
    --5
    awful.key({modkey,            }, "KP_Begin", 
              function () awful.spawn("discord", {tags="7-chat", screen=2}) end,
              {description = "5 Discord", group = "applications"}),
    --6
    awful.key({modkey,            }, "KP_Right", 
              function () awful.spawn(terminal.." -e weechat",{tag="7-chat", screen=2}) end,
              {description = "6 WeeChat", group = "applications"}),
    --7
    awful.key({modkey,            }, "KP_Home", 
              function () awful.spawn("gnome-calculator", {tag="2-notes", screen=2}) end,
              {description = "7 Calculator", group = "applications"}),
    --8
    awful.key({modkey,            }, "KP_Up", 
              function () awful.spawn("code", {tag="6-dev2", screen=1}) end,
              {description = "8 Edit Awesome config", group = "applications"}),
    --9
    awful.key({modkey,            }, "KP_Page_Up", 
              function () awful.spawn("firefox myapps.dollarbank.com", {tag="1", screen=1}) end,
              {description = "9 Dollar Citrix", group = "applications"}),
